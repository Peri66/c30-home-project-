...
function setup() {
  ...
  polygon_img = new Polygon(100,200);
  slingShot = new Launcher(polygon_img.body,{x:100,y:200});

  block16 = new Block(620,175,30,40);
